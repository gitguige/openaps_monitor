...
#################################### Context table check #################################################################
	...
	if glucose < 39:
		if running_temp_rate >= basal:
			if loaded_glucose["rate"] == 0 and loaded_glucose["duration"] == 0 :
				print("\nNO Fault\n")
			else:
				print("\n***************************************")
				print("********** Faultiy !!!!! *************")  	
	...
	if glucose >=39 and glucose < 75:
		if loaded_glucose["rate"] == 0 or loaded_glucose["rate"] == basal:
			print("\n NO fault\n")
		else:
	...
	recommended_change_rate = running_temp_rate - loaded_suggested_data["rate"]
	...
	if glucose >= 75:
		if e_bg > bg_target:
			if recommended_change_rate >= 0:
				...
				if recommended_change_rate <= -0.20:
					print("\nNO Fault\n")
				else:
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "Reason: glucose > 75; e_bg > bg_target; recommended_rate decreases more than .20 unit" 
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")  	
					print("Reason: glucose > 75; e_bg > bg_target; recommended_rate decreases more than .20 unit")
					print("***************************************\n")
			
	################# Context table fourth and fifth row ########################
		if e_bg < bg_target:
			if e_bg - prev_e_bg > 0 and bg_target - e_bg <= 4: # While e_bg value is at best 4 unit lower than bg_target but rising towards target
				if recommended_change_rate < 0: # In this situation rate should not be decreased
					loaded_suggested_data["fault"] = "yes"
					loaded_suggested_data["fault_reason"] = "e_bg > 75; e_bg < bg_target by maximum 4 unit; e_bg is rising; rate should not decrease but it decreases"
					print("\n***************************************")
					print("********** Faultiy !!!!! *************") 
					print("Reason: e_bg > 75; e_bg < bg_target by maximum 4 unit; e_bg is rising; rate should not decrease but it decreases") 	
					print("***************************************\n")
			
			if e_bg - prev_e_bg < 0 and bg_target - e_bg <= 9: # while e_bg is within 9 unit lower than bg_target and falling, rate should not rise
				if recommended_change_rate > 0:
					loaded_suggested_data["fault"] = "yes"	
					loaded_suggested_data["fault_reason"] = "e_bg > 75; e_bg is within 9 units below bg_target and falling; rate should not increase, but it increases"
					print("\n***************************************")
					print("********** Faultiy !!!!! *************")
					print("Reason: e_bg > 75; e_bg is within 9 units below bg_target and falling; rate should not increase, but it increases")  	
					print("***************************************\n")
