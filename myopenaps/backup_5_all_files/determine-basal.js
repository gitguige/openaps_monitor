...
//####### Added by me, following 3 lines are commented at 237-239 and rest 12 lines are at 291-301 lines ##############################
...
//############################ ################################# End ############################################################
	...
	rT.bg = bg; //ahmed
	rT.bgi = bgi; //ahmed
	rT.basal = basal; //ahmed
	rT.running_temp = currenttemp; //ahmed
	rT.deviation = deviation; //ahmed
	rT.expectedDelta = expectedDelta; //ahmed
	rT.minDelta = minDelta; //ahmed
	rT.minAvgDelta = minAvgDelta; //ahmed
	rT.eventualBG = eventualBG; //ahmed
    }
    ...
    if (bg < 39 || minAgo > 12 || minAgo < -5) {
		...
		rT.minDelta = minDelta; //ahmed
		rT.minAvgDelta = minAvgDelta; //ahmed
		rT.eventualBG = 0; //ahmed
            rT.duration = 0; //uncommented by default, commented by me
            rT.rate = 0; //uncommented by default, commented by me
            return rT;
		...
		rT.bgi = bgi; //ahmed
		rT.deviation = deviation; //ahmed
		rT.expedtedDelta = expectedDelta; //ahmed
		rT.minDelta = minDelta; //ahmed
		rT.minAvgDelta = minAvgDelta; //ahmed
		rT.eventualBG = 0; //ahmed
            rT.duration = 30;
		...
		rT.eventualBG = 0; //ahmed
            ...
            rT.duration = currenttemp.duration //ahmed
		//rT.basal = basal;
            return rT;
        }
    }
...
//
	...
	, 'basal': basal //ahmed
	, 'bgi': bgi //ahmed
	, 'target_bg': target_bg //ahmed
	, 'short_avgdelta': glucose_status.short_avgdelta //ahmed
	, 'long_avgdelta': glucose_status.long_avgdelta //ahmed
	, 'delta': glucose_status.delta //ahmed
	, 'minDelta': minDelta //ahmed
	, 'minAvgDelta': minAvgDelta //ahmed
	//, 'iob': iob_data.iob //ahmed
	, 'expectedDelta': expectedDelta //ahmed
	, 'running_temp': currenttemp //ahmed
        , 'bg': bg //ahmed
	, 'naive_eventualBG': naive_eventualBG //ahmed
	, 'min_bg': min_bg //ahmed
	, 'max_bg': max_bg //ahmed
	, 'deviation': deviation //ahmed
        , 'tick': tick
