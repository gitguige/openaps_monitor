...
python3 bgrisk_monitor_constrain_WOT.py $(pwd)/simulationCollectdata_hardware/ $(pwd)/../myopenaps/fault_library_monitor/scenario_  summary_monitor_hardware_WOT.csv
...
python3 bgrisk_monitor_constrain_faultfree_WOT.py $(pwd)/faultFreeSimulation_data/  summary_faultfree_WOT.csv
